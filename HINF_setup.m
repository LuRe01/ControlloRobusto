...
% Tuning definitivo:
%
% - Ms leggermente aumentato per rilassare il picco ammesso di sensibilita';
% - banda richiesta moderata per preservare robustezza e margini;
% - WU = 0.90 I per sfruttare il margine disponibile sull'azione di controllo;
% - WT con transizione a 22/18 rad/s per limitare la dinamica ad alta frequenza.
%
% Il compromesso finale porta gamma nominale < 1 per mixsyn/hinfsyn,
% mantenendo i requisiti temporali nominali e la robust stability.
% ========================================================================
