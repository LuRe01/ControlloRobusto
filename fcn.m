...
%#codegen
% NOTE TEORICHE - DINAMICA NON LINEARE INCERTA
% La funzione implementa le equazioni non lineari dell'elicottero 2DOF con
% parametri perturbati tramite variabili normalizzate delta in [-1,1].
% Questo modello e' utile per verifiche nel dominio del tempo e per la RAS,
% dove la robustezza viene valutata oltre la sola approssimazione lineare.
%
